...
class Profile extends BaseController
{
    ...
    public function profile()
    {
        ...
        if (!empty($admin['profile_picture'])) {
            ...
            if (!preg_match('/^https?:\/\//', $admin['profile_picture'])) {
                $admin['profile_picture'] = base_url("admin/profile/image/{$adminId}");
            }
        }
        ...
        return view('admin/ad-profile', $data);
    }
    ...
    public function updateProfile()
    {
        ...
        if (!empty($errors)) {
            ...
            return redirect()->to('/admin/ad-profile')->withInput();
        }
        ...
        if (!empty($updatedAdmin['profile_picture'])) {
            if (!preg_match('/^https?:\/\//', $updatedAdmin['profile_picture'])) {
                $profilePictureUrl = base_url("admin/profile/image/{$adminId}");
        ...
        return redirect()->to('/admin/ad-profile');
    }
    ...
    public function updateProfilePicture()
    {
        ...
        if ($file->isValid() && !$file->hasMoved()) {
            ...
            $session->set('profile_picture', base_url("admin/profile/image/{$adminId}"));

            return $this->response->setJSON([
                'success' => true,
                'message' => 'Profile picture updated successfully',
                'profile_picture' => base_url("admin/profile/image/{$adminId}")
            ]);
        }
