...
<head>
  ...
  <title>Home | USTP Library Dashboard</title>
...
<body>
  ...
  <aside class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li><a href="reports" class="active"><img src="<?= base_url('assets/icons/report.png') ?>" alt="Reports">Reports</a></li>
  ...
  <main class="main-content">
    ...
    <div class="summary-cards">
      <div class="summary-card section-visit">
        <img src="<?= base_url('assets/icons/section.png') ?>" alt="Section">
        <div class="summary-info">
          <h3>Most Visited Section</h3>
          <p id="totalAttendance" aria-label="Most visited section name" data-type="text">Loading...</p>
        </div>
      </div>
      <div class="summary-card busiest-hour">
        ...
        <div class="summary-info">
          <h3>Busiest Hour</h3>
          <p id="uniqueStudents" aria-label="Busiest hour" data-type="text">Loading...</p>
        </div>
      </div>
      <div class="summary-card total-attendance">
        ...
        <div class="summary-info">
          ...
          <p id="totalVisits" aria-label="Total attendance this week" data-type="number">0</p>
        </div>
      </div>
      <div class="summary-card active-course">
      ...
      <div class="charts-carousel">
        ...
        <div class="charts-container">
          ...
          <div class="chart-panel" data-chart="3">
            <h2>Top Students Visited to the USTP Library - Claveria</h2>
      ...
      <div class="panel active">
        ...
        <div class="management-content active">
          ...
          <div class="filter-control-bar">
            <!-- First Row: Section, College, Course, Year Level -->
          ...
          <!-- Second Row: Start Date, End Date, Filter Button, Reset Button, Time Period on Left -->
          <div class="filter-control-bar filter-second-row">
            <div class="filter-group time-period-group">
